...
generator = pipeline(task='text-generation', model=f"/home/dsi/yxiao/plm/ckpt/merge/7B-{template_name}-{dataset_name}", device_map="auto", batch_size=32, max_new_tokens=512)
